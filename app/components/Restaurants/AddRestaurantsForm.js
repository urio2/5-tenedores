...
function UploadImage(props) {
    ...
    const imageSelect = async () => {
        ...
        if(resultPermissions === "denied") {
            toastRef.current.show(
                "Es necesario aceptar los permisos de galería, si los has rechazado tienes que ir a ajustes y activarlos manualmente",
                3000
            );
        } else {
    ...
    const removeImage = (image) => {
        ...
        Alert.alert(
            "Eliminar imagen",
            "¿Estás seguro de que quieres eliminar la imagén?",
            [
                {
                    text: "Cancel",
                    style: "cancel"
