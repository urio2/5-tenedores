...
export default function ChangePasswordForm(props) {
    ...
    const onSubmit = async () => {
        ...
        if(
            ...
            errorsTemp = {
                newPassword: "La contraseña tiene que ser mayor que tenere más de 5 carácteres",
                repeatNewPassword: "La contraseña tiene que ser mayor que tenere más de 5 carácteres"
            };
        } else {
            setIsLoading(true);
